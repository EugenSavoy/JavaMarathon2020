...
public class Day7AirplaneTest extends AbstractTest {
    ...
    public void firstLongerSecond() {
        ...
        assertEquals("Второй самолет длинее" + System.lineSeparator(), getOutput(), "Самолет 1 длина 100, самолет 2 длина 200");
    }

    @Test
    public void secondLongerFirst() {
        Airplane.compareAirplanes(a2, a1);
        assertEquals("Первый самолет длинее" + System.lineSeparator(), getOutput(), "Самолет 1 длина 200, самолет 2 длина 100");
    }
